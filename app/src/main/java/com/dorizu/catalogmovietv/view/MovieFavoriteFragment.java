...
import com.dorizu.catalogmovietv.helper.MappingMovieHelper;
...
public class MovieFavoriteFragment extends Fragment implements LoadMoviesCallback, MovieFavoriteAdapater.OnItemClickListener {
    ...
    private static class LoadMoviesAsync extends AsyncTask<Void, Void, ArrayList<FavoritItem>> {
        ...
        protected ArrayList<FavoritItem> doInBackground(Void... voids) {
            ...
            return MappingMovieHelper.mapCursorToArrayList(dataCursor);
        }
